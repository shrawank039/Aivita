...
public class MainMenuFragment extends RootFragment implements View.OnClickListener {
    ...
    private void setupTabIcons() {
        ...
        imageView1.setImageDrawable(getResources().getDrawable(R.drawable.ic_home_run));
        title1.setText("Home");
        ...
        imageView4.setImageDrawable(getResources().getDrawable(R.drawable.ic_notifications_black_24dp));
        ...
        imageView5.setImageDrawable(getResources().getDrawable(R.drawable.ic_person_black_24dp));
        ...
        tabLayout.addOnTabSelectedListener(new TabLayout.OnTabSelectedListener(){
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()){
                    case 0:
                        OnHome_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_home_run));
                    ...
                    case 1:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_search_avita));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.colorwhite_50), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.colorwhite_50));
                        break;


                    case 3:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_notifications_black_24dp));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.colorwhite_50), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.colorwhite_50));
                        break;
                    case 4:
                        Onother_Tab_Click();
                        image.setImageDrawable(getResources().getDrawable(R.drawable.ic_person_black_24dp));
                        image.setColorFilter(ContextCompat.getColor(context, R.color.colorwhite_50), android.graphics.PorterDuff.Mode.SRC_IN);
                        title.setTextColor(context.getResources().getColor(R.color.colorwhite_50));
                        break;
                }
    ...
    public void OnHome_Click (){
        ...
        image.setImageDrawable(context.getResources().getDrawable(R.drawable.ic_videocam_black_24dp));
        ...
        imageView3.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
        ...
        ImageView imageView4= view4.findViewById(R.id.image);
        imageView4.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
    ...
    public void Onother_Tab_Click(){
        ...
        ImageView imageView1= view1.findViewById(R.id.image);
        imageView1.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
        tex1.setTextColor(context.getResources().getColor(R.color.dark_gray));
        tab1.setCustomView(view1);
        ...
        imageView3.setColorFilter(ContextCompat.getColor(context, R.color.app_color), android.graphics.PorterDuff.Mode.SRC_IN);
        TextView tex3=view3.findViewById(R.id.text);
        tex3.setTextColor(context.getResources().getColor(R.color.dark_gray));
        tab3.setCustomView(view3);
